...
<div class="jv_headline_accord_container" style="<?php echo $modHeight; ?>" id="jv_accordion<?php echo $moduleId; ?>">
	...
	<div class="featured">		
		...
		</h4><div class="introtext"><?php echo $item->introtext; ?></div></div>
		<img class="thumb-images" width="<?php echo $thumbWidth; ?>" height="<?php echo $thumbHeight; ?>" src="<?php echo $item->thumbl;?>" alt="image" />
