...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Latest items from author -->
	<h3 class="jvk2titlebox"><span><?php echo JText::_("Latest from"); ?> <?php echo $this->item->author->name; ?></span></h3>
  ...
  <!-- Related items by tag -->
	<h3 class="jvk2titlebox"><span><?php echo JText::_("Related items (by tag)"); ?></span></h3>
  ...
  <h3 class="jvk2titlebox"><span><?php echo JText::_('Related Video'); ?></span></h3>
  ...
  <h3 class="jvk2titlebox"><span><?php echo JText::_('Image Gallery'); ?></span></h3>
 ...
 <?php if($this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)):?>
  ...
  <div class="itemComments">
	  ...
	  <!-- Item user comments -->
	  <h3 class="jvk2titlebox"><span><?php echo ($this->item->numOfComments>1) ? JText::_('comments') : JText::_('comment'); ?> (<?php echo $this->item->numOfComments; ?>)</span></h3>
	  <div class="itemListsComments">
